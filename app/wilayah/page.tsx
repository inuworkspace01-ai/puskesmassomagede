...
import { MapPin, ExternalLink, Navigation, Layers3, Map, LocateFixed } from 'lucide-react';
  ...
  return <PageTransition><main>
    <section className="pageHero regionHero">
      <div className="container">
        ...
        <p>Jelajahi wilayah kerja Puskesmas Somagede dan buka lokasi desa langsung dari perangkatmu.</p>
      </div>
    </section>
      ...
      <div className="container">
        <div className="mapShell3d">
          <div className="mapCopy3d">
            <div className="eyebrow">PETA AREA</div>
            <div className="mapTitleRow"><div><h2>Wilayah kerja Somagede</h2><p>Peta interaktif dibuat lebih ringan untuk mobile. Tampilan panggung dibuat berperspektif agar terasa lebih hidup; gunakan Google Maps untuk navigasi dan eksplorasi 3D penuh sesuai dukungan perangkat.</p></div><div className="mapBadge"><LocateFixed size={15}/> 9 desa</div></div>
            <div className="mapActions"><a className="btn primary" href="https://www.google.com/maps/search/?api=1&query=Kecamatan+Somagede+Banyumas" target="_blank" rel="noreferrer"><Navigation size={17}/> Buka Google Maps</a><a className="btn secondary" href="https://www.google.com/maps/search/?api=1&query=Puskesmas+Somagede+Banyumas" target="_blank" rel="noreferrer"><Map size={17}/> Puskesmas</a></div>
            <div className="mapLegend"><span><i className="legendDot"/> Area layanan</span><span><Layers3 size={14}/> Mode perspektif</span></div>
          </div>
          <div className="mapStage">
            <div className="mapPlatform">
              <iframe title="Peta Kecamatan Somagede" src="https://www.google.com/maps?q=Kecamatan+Somagede,+Banyumas&output=embed" loading="lazy"/>
            </div>
